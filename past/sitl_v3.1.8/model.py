...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def step(self):
        ...
        #print(self.reward_based_gain_and_activity())
    ...
    def reward_based_gain_and_activity(self):
        if(self.step_n <3):
            return 0
        reward=0
        #robot이 agent를 끌어당기면 +reward
        ...
        if(len(self.robot.past_xy)==10):
            how_far_go = math.sqrt(pow(self.robot.past_xy[0][0]-self.robot.xy[0],2)+pow(self.robot.past_xy[0][1]-self.robot.xy[1],2))
            print("how_far_go : ", how_far_go)
            reward += how_far_go/3
