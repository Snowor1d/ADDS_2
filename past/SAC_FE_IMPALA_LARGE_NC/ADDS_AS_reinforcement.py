...
class ImpalaCNN(nn.Module):
    ...
    def __init__(self, input_shape, in_channels=4, channels=[32, 64, 64, 64, 64], out_dim=256, compress=True):
...
##########################################################################
# 2) Critic (Q) Network (Uncompressed)
##########################################################################
class QNetwork(nn.Module):
    def __init__(self, ego_shape=(25, 25), global_shape=(50, 50), action_dim=2, robot_dim=3, use_robot: bool=True):
        ...
        # compress=False를 주어 각각 2048, 6272 차원을 그대로 출력하게 합니다.
        ...
        self.film = nn.Sequential(
            ...
            nn.SiLU(),
            # img_dim이 커졌으므로 여기서 파라미터 수가 크게 증가합니다 (약 400만 개)
...
##########################################################################
# 3) Policy (Actor) Network (Uncompressed)
##########################################################################
