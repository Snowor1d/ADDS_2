...
class ImpalaCNN(nn.Module):
    def __init__(self, input_shape, in_channels=4, channels=[16, 32, 32], out_dim=256):
...
class QNetwork(nn.Module):
    def __init__(self, ego_shape=(25, 25), global_shape=(50, 50), action_dim=2, robot_dim=3, use_robot: bool=True):
        ...
        # 독립적인 가중치를 가짐
        self.ego_enc = ImpalaCNN(input_shape=ego_shape, in_channels=4, channels=[16, 32, 32], out_dim=256)
        self.glob_enc = ImpalaCNN(input_shape=global_shape, in_channels=4, channels=[16, 32, 32], out_dim=512)
...
class PolicyNetwork(nn.Module):
    def __init__(self, ego_shape=(25, 25), global_shape=(50, 50), robot_dim=3, use_robot: bool=True):
        ...
        # Fusion Dimension = Ego_CNN(256) + Global_CNN(512) + Robot
