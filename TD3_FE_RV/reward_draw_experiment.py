...
ROBOT_LEARNED_MODEL = "3maps.pth"  # resolved by the TD3 checkpoint loader
...
def _release_training_only_objects(env) -> None:
    ...
    for attr in (
        ...
        if hasattr(env.td3_agent, attr):
            setattr(env.td3_agent, attr, None)
    gc.collect()
