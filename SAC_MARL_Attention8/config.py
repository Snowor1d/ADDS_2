...
# Local Reward, Impala CNN, Attention for fused state (global+ego+auxiliary state), individual Q valued, film with ego info, spatial attention with dot-product
# ------------- BASIC PARAMETERS ------------------
LR = 1e-4
BUFFER_SIZE = 1000000
BATCH_SIZE = 128
...
# -------------- PATH -------------------
LOG_DIR = "Log_MARL_Attention8_105_108_128"
#LOG_DIR = "SOTA_MODELS"
#LOG_DIR = "Log_test"
PORT_NUM = 7788
