...
DREAMER_DISCRETE_SIZE = 4 #class size
DREAMER_HIDDEN_SIZE = 64
DREAMER_EMBED_SIZE = 64
DREAMER_ACTION_EMBED_SIZE = 64
DREAMER_CONV_DEPTH = 4
DREAMER_RSSM_BLOCKS = 8
DREAMER_IMAG_LAST = -1  # 0: all posterior states, >0: last K states, -1: random single state
