...
# - Uses the official DreamerV3 size25m width profile: recurrent=3072,
#   hidden units=384, base CNN depth=24, and 24 codes per stochastic latent.
#   All other training and environment settings remain identical to
#   DREAMER_MARL17.
# ------------- DREAMER V3 ------------------
DREAMER_REPLAY_CAPACITY = 2000000
...
DREAMER_DETER_SIZE = 3072
DREAMER_STOCH_SIZE = 32
DREAMER_DISCRETE_SIZE = 24 # codes per latent
DREAMER_HIDDEN_SIZE = 384
DREAMER_EMBED_SIZE = 256
DREAMER_ACTION_EMBED_SIZE = 256
DREAMER_CONV_DEPTH = 24
