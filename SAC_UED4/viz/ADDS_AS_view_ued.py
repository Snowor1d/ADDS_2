...
Examples
    python3 -m viz.ADDS_AS_view_ued difficulty --out /tmp/tiers.png
    python3 -m viz.ADDS_AS_view_ued lineage --difficulty 0 --steps 8
    python3 -m viz.ADDS_AS_view_ued population --state ~/Log_SAC_UED/ued_curriculum.pkl
"""
...
def cmd_population(args) -> None:
    ...
    if not runner.enabled:
        raise SystemExit("TRAIN_MAP_SOURCE is not 'ued' in configs/training/common.py, so nothing will load")
