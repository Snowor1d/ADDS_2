...
from learn.ADDS_AS_reinforcement import ReplayBuffer
from config import *
from paths import at
from viz.continuous_renderer import ContinuousRenderer
from sim.scenario import level_from_config
import sim.robot_action as robot_action
...
# The world to play in is the level's own.
WORLD_W = int(SCENARIO_LEVEL.width)
WORLD_H = int(SCENARIO_LEVEL.height)
...
CONT_ROBOT_IMAGE_PATH = at("images", "robot.png")
