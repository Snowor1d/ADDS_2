...
#
# Experiment variant: DREAMER_MARL16_s
# - Small-width version of DREAMER_MARL16 targeting roughly one third of its
#   training compute and VRAM while preserving batch/sequence semantics.
...
DREAMER_DETER_SIZE = 1152
DREAMER_STOCH_SIZE = 18
DREAMER_DISCRETE_SIZE = 16 #class size
DREAMER_HIDDEN_SIZE = 144
DREAMER_EMBED_SIZE = 144
DREAMER_ACTION_EMBED_SIZE = 144
DREAMER_CONV_DEPTH = 10
