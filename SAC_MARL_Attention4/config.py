...
# Local Reward, Impala CNN, Attention for fused state (global+ego+auxiliary state), individual Q valued, film, MAAC baseline
# ------------- BASIC PARAMETERS ------------------
LR = 1e-4
BUFFER_SIZE = 1000000
BATCH_SIZE = 128
...
# -------------- PATH -------------------
LOG_DIR = "Log_MARL_Attention4_105_108_128"
#LOG_DIR = "SOTA_MODELS"
#LOG_DIR = "Log_test"
PORT_NUM = 7627
