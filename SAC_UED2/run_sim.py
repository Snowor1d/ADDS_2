...
def _parse_args():
    ...
    ap.add_argument("--generated", action="store_true",
                    help="ignore SIM_REAL_SITE and drive the numbered maps")
...
if __name__=="__main__":
    ...
    if _site:
        ...
        print(f"[run_sim] real level {_site} at {_size} m: "
              ...
              f"{REAL_LEVEL.crowd_size} pedestrians, exits {REAL_LEVEL.exit_source}")
    else:
        print("[run_sim] numbered maps from map_infos "
              "(set SIM_REAL_SITE in config.py to watch a real crop)")
    main()
