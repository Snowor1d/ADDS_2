...
from ADDS_AS_reinforcement import SACAgent, ReplayBuffer, PolicyNetwork, QNetwork, ACTION_SCALE, FrameStack, make_frame
...
def map_info(map_num): #map_num 넣으면 output으로 (obstacle_info, size)
    ...
    if (map_num == 1):
        obstacles.append([[10, 10], [16, 10], [10, 16]])
        obstacles.append([[34, 10], [40, 10], [40, 16]])
        obstacles.append([[10, 34], [16, 40], [10, 40]])
        obstacles.append([[40, 34], [40, 40], [34, 40]])
        return obstacles, 50
    elif map_num == 2: #오른쪽 하단
        obstacles.append([[8, 8], [25, 8], [25, 13], [8, 13]])
        obstacles.append([[8, 16], [14, 16], [14, 25], [8, 25]])
        obstacles.append([[20, 16], [25, 16], [25, 34], [20, 34]])
        obstacles.append([[33, 16], [40, 16], [40, 34], [33, 34]])
        obstacles.append([[8, 40], [13, 40], [13, 45], [8, 45]])
        obstacles.append([[18, 40], [35, 40], [35, 45], [18, 45]])
        return obstacles, 50
    elif map_num == 3:
        obstacles.append([[15, 8], [20, 8], [20, 15], [15, 20]])
        obstacles.append([[20, 21], [20, 28], [15, 28]])
        obstacles.append([[35, 8], [43, 8], [43, 15], [35, 15]])
        obstacles.append([[35, 21], [43, 21], [43, 28], [35, 28]])
        obstacles.append([[7, 40], [40, 40], [40, 45], [7, 45]])
        return obstacles, 50

    elif map_num == 4: #오른쪽 상단
        obstacles.append([[12, 12], [18, 12], [18, 25], [12, 25]])
        obstacles.append([[25, 12], [40, 12], [40, 20], [25, 20]])
        obstacles.append([[12, 38], [30, 38], [30, 45], [17, 45]])
        return obstacles, 50

    elif map_num == 5: #오른쪽 상단
        obstacles.append([[10, 10], [15, 10], [15, 35], [10, 35]])
        obstacles.append([[20, 10], [25, 10], [25, 35], [20, 35]])
        return obstacles, 50

    elif map_num == 6:
        obstacles.append([[10, 10], [20, 10], [20, 20], [10, 20]])
        obstacles.append([[10, 30], [40, 30], [40, 40], [10, 40]])
        return obstacles, 50

    elif map_num == 7:
        obstacles.append([[10, 30], [20, 30], [28, 40], [10, 40]])
        obstacles.append([[30, 10], [35, 10], [35, 30], [30, 30]])
        obstacles.append([[10, 10], [15, 10], [15, 15], [10, 15]])
        obstacles.append([[15, 20], [22, 20], [22, 25], [15, 25]])
        obstacles.append([[35, 35], [40, 35], [40, 40], [35, 40]])
        return obstacles, 50

        
    elif map_num == 8:
        obstacles.append([[10, 15], [25, 15], [10, 40]])
        obstacles.append([[30, 20], [40, 20], [40, 35], [30, 35]])
        return obstacles, 50

            
    elif map_num == 9:
        obstacles.append([[10, 15], [35, 15], [35, 25], [10, 25]])
        obstacles.append([[0, 35], [20, 35], [20, 40], [0, 40]])
        obstacles.append([[30, 40], [40, 30], [40, 40]])
        return obstacles, 50
    
    elif map_num == 10:
        obstacles.append([[10, 30], [15, 30], [15, 40], [10, 40]])
        obstacles.append([[30, 20], [40, 20], [40, 35], [30, 35]])
        obstacles.append([[41, 10], [45, 10], [45, 25], [41, 25]])
        return obstacles, 50

    elif map_num == 11:
        obstacles.append([[10, 5], [40, 5], [40, 20]])
        obstacles.append([[6, 25], [10, 25], [10, 40], [6, 40]])
        obstacles.append([[11, 32], [40, 32], [40, 40], [11, 40]])
        return obstacles, 50

    elif map_num == 12:
        obstacles.append([[15, 10], [40, 35], [35, 40], [10, 15]])
        obstacles.append([[20, 0], [35, 0], [35, 15]])
        obstacles.append([[10, 40], [20, 49], [10, 49]])
        return obstacles, 50


    elif map_num == 13:
        obstacles.append([[10*2, 10*2], [20*2, 10*2], [20*2, 20*2], [10*2, 20*2]])
        obstacles.append([[10*2, 30*2], [40*2, 30*2], [40*2, 40*2], [10*2, 40*2]])
        return obstacles, 100

    elif map_num == 14:
        obstacles.append([[10*2, 30*2], [20*2, 30*2], [28*2, 40*2], [10*2, 40*2]])
        obstacles.append([[30*2, 10*2], [35*2, 10*2], [35*2, 30*2], [30*2, 30*2]])
        obstacles.append([[10*2, 10*2], [15*2, 10*2], [15*2, 15*2], [10*2, 15*2]])
        obstacles.append([[15*2, 20*2], [22*2, 20*2], [22*2, 25*2], [15*2, 25*2]])
        obstacles.append([[35*2, 35*2], [40*2, 35*2], [40*2, 40*2], [35*2, 40*2]])
        return obstacles, 100

        
    elif map_num == 15:
        obstacles.append([[10*2, 15*2], [25*2, 15*2], [10*2, 40*2]])
        obstacles.append([[30*2, 20*2], [40*2, 20*2], [40*2, 35*2], [30*2, 35*2]])
        return obstacles, 100
...
class FightingModel(Model):
    ...
    def __init__(self, number_agents: int, model_num = -1, robot = 'Q'):
        ...
        self.valid_space = {}
        self.grid = MultiGrid(self.map_size, self.map_size, False)
        self.headingding = ContinuousSpace(self.map_size, self.map_size, False, 0, 0)
        self.fill_outwalls(self.map_size, self.map_size)
        self.mesh_map()
