...
DREAMER_DETER_SIZE = 1280
DREAMER_STOCH_SIZE = 32
DREAMER_DISCRETE_SIZE = 10 #class size
DREAMER_HIDDEN_SIZE = 160
DREAMER_EMBED_SIZE = 160
DREAMER_ACTION_EMBED_SIZE = 160
DREAMER_CONV_DEPTH = 10
DREAMER_RSSM_BLOCKS = 8
DREAMER_IMAG_LAST = 8  # 0: all posterior states, >0: last K states, -1: random single state
