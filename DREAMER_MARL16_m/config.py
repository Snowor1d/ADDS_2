...
#
# Experiment variant: DREAMER_MARL16_m
# - Medium-width version of DREAMER_MARL16 targeting roughly two thirds of
#   its training compute and VRAM while preserving batch/sequence semantics.
# - Scales deterministic, stochastic, MLP, and CNN widths together and uses
#   a proportionally smaller decoder chunk.
...
DREAMER_DETER_SIZE = 1664
DREAMER_STOCH_SIZE = 26
DREAMER_DISCRETE_SIZE = 16 #class size
DREAMER_HIDDEN_SIZE = 208
DREAMER_EMBED_SIZE = 208
DREAMER_ACTION_EMBED_SIZE = 208
