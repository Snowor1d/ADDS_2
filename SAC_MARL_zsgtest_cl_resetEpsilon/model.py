...
class FightingModel(Model):
    ...
    def __init__(self, number_agents: int, width: int, height: int, model_num = -1, robot = 'Q', robot_num = 1, difficulty = 0):
    ...
    def extract_map(self, map_num):
        ...
        if map_num == 0:
            self.make_random_exit_2(difficulty=self.difficulty)
            return
