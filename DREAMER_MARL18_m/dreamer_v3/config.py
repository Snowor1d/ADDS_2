...
class DreamerConfig:
    ...
    deter_size: int = 1792
    stoch_size: int = 32
    discrete_size: int = 14
    hidden_size: int = 224
    embed_size: int = 256
    action_embed_size: int = 256
    conv_depth: int = 14
    vector_encoder_layers: int = 3
    rssm_blocks: int = 8
    # Number of uniformly sampled, valid posterior states used as imagination
    # starts per replay sequence. Sampling is without replacement.
    imag_starts_per_sequence: int = 16
    twohot_bins: int = 255
    ...
    vector_decoder_layers: int = 3
    decoder_chunk_size: int = 128
    skip_context_prediction: bool = True
