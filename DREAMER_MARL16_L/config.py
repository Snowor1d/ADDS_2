...
#
# Experiment variant: DREAMER_MARL16_L
# - Large-width version of DREAMER_MARL16 targeting the DreamerV3 25M
#   parameter scale (25,011,165 trainable model parameters).
# - Scales deterministic, stochastic, MLP, and CNN widths together while
#   preserving batch/sequence semantics and the MARL16 architecture.
# - Uses a larger decoder chunk to match the increased model width.
# - Retains every MARL16 correctness fix and its encoder/decoder structure.
#
# DREAMER_MARL16 correctness baseline:
...
DREAMER_DETER_SIZE = 2672
DREAMER_STOCH_SIZE = 41
DREAMER_DISCRETE_SIZE = 16 #class size
DREAMER_HIDDEN_SIZE = 328
DREAMER_EMBED_SIZE = 328
DREAMER_ACTION_EMBED_SIZE = 328
DREAMER_CONV_DEPTH = 20
...
DREAMER_DECODER_CHUNK_SIZE = 160
