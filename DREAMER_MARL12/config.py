...
#
# Experiment variant: DREAMER_MARL12
# - Keeps the DREAMER_MARL7 REINFORCE actor update.
# - Otherwise follows DREAMER_MARL11: DreamerV3-style block-spatial image
#   decoder (decoder_bspace=8), update-aware policy broadcasts, and ego
#   reconstruction loss masked to real robot slots.
# ------------- DREAMER V3 ------------------
