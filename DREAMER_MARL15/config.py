...
#
# Experiment variant: DREAMER_MARL15
# - Based on DREAMER_MARL14.
# - Fixes the RSSM GRU gate unpacking so reset/candidate/update stay aligned
#   inside each of the eight deterministic blocks.
# - Replaces the custom image/vector encoder with a DreamerV3-style encoder
#   adapted to the current 25x25 ego and 50x50 global maps.
...
# - Uses three image upsampling stages so 25x25 ego maps start at 4x4 and
#   50x50 global maps start at 7x7 before final size adjustment.
# - Actor, ego slot loss, and broadcast behavior stay identical to
#   DREAMER_MARL7.
# ------------- DREAMER V3 ------------------
